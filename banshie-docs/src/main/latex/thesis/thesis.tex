...
% paragraph headlines in bold face and with margin
\makeatletter
...
\newacronym{DIMA}{DIMA}{Database Systems and Information Management}
\newacronym{OBD}{OBD}{One Best per Document}
\newacronym{AO}{AO}{All Occurences}

\bibliography{thesis}
\title{Design and Implementation of a \\ Modular Benchmarking Framework to \\ Evaluate Information Extraction Quality}
\author{Willi Schönborn, 774190 \\ Thesis Advisor: Prof. Dr. Stefan Edlich \\ Second Assessor: Prof. Dr. Agathe Merceron}
\date{\today}
