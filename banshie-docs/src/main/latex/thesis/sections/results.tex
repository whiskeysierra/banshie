...
The \gls{API} provided by Stanford CoreNLP is different from Apache OpenNLP as it is designed around pipelines. 
...
% nice example of common evaluation result: possible tradeoff between different extractors: better results for more cpu time and memory! 