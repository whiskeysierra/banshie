...
A possible solution to the problem described above is provided by the error measure ERR defined by MUC \cite{Chinchor:1995}\cite{Makhoul:1999}. 
...
An important metric to measure the runtime performance of a program is the process CPU time which determines how much time in the CPU a process spent during its execution. 

\fxfatal{What does it say? Why is it important?}
...
\fxfatal{Peak vs average? Why is it important?}