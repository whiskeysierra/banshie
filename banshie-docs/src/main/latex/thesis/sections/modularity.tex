...
\fxfatal{Relevance to this thesis?!}
...
\fxfatal{Better connect to previous sections. Why was OSGi chosen?}
...
\fxfatal{Shows that OSGi is a proven, reliable platform spec, used in many projects and under continious development for many years. Rock solid, obvious choice for highly modular java systems.}
...
\fxfatal{Which did I use and why?}