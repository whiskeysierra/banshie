...
\fxfatal{It's text analysis, not only HTML pages}
...
\fxfatal{Web information extraction}
...
\fxfatal{Move to history/programs}
...
\fxfatal{Ontologies and Knowledge Base construction}
