...
\fxfatal{Problem description}
% Why do we need IE?
% Why is IE hard?
% Why are extractors hard to evaluate? (different interfaces/output)
% Whch measurements are available?
% Which measures are the best for IE?
