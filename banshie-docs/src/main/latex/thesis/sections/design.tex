...
\fxfatal{Describe module groups}
% banshie-api (public api, main module)
% banshie-corpora, banshie-extractors, banshie-execution, banshie-eval-performance, banshie-eval-quality (corresponds to package hierarchy)
% banshie-execution's dependencies!
% event modules: internal interface
% banshie-common, banshie-jpa, banshie-persistence

% no module depends on other *-impl modules
