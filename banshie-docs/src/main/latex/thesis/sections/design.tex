...
The default \texttt{QualityEvaluator} implementation has serveral tasks. It needs to map the prediction to rthe eference, count true positives, false positives, false negatives, run configured scoring metrics and collect their results.
...
Read log file line by line, deserialize event, call update on configured calculators, collect results
